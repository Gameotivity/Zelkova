  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <div className="rounded-2xl border border-[#1E293B] bg-[#0F1629] p-16 text-center">
        ...
        <h2 className="text-xl font-bold text-[#F8FAFC]">AI Trading Agents -- Coming Soon</h2>
        <p className="mx-auto mt-2 max-w-md text-sm text-[#94A3B8]">
          We are building the next generation of autonomous AI trading agents for Hyperliquid. Join the waitlist to be the first to deploy.
        </p>
        <button disabled className="mt-6 rounded-xl bg-[#00E5FF]/10 px-6 py-3 text-sm font-semibold text-[#00E5FF] opacity-60 cursor-not-allowed">
          Join Waitlist
        </button>
      </div>
    </div>
